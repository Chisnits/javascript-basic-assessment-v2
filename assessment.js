...
var index = jedi.indexOf('Yoda');
var firstJedi = jedi.shift(index, 1);
...
// secondjedi = jedi.slice(2);
// var secondJedi = jedi[3];
...
function spiderTest(person) {
	if (person.name === 'Andrew Garfield'){
		person.spiderRating = 10;
	} else if (person.name === "Tobey Maguire"){
		person.spiderRating = 0;
	} else (person.spiderRating = 'not a spiderman');
}
